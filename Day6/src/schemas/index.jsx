...
export const signUpSchema=Yup.object({
    ...
    password:Yup.string().matches(/^[0-9a-zA-Z$@^*]{8,15}$/,"length must be gretaer than 8 and less than 15").required("Please Enter Your password"),
    cpassword:Yup.string().required().oneOf([Yup.ref("password"),null],"Password doen't match")
})